...
//
// On Thu Jun 10 21:52:25 PDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter4B(wciS0_Clk,
  ...
  wire [23 : 0] mesgMetaF_length__h16865, mesgMetaF_length__h17776;
  wire [15 : 0] wsiBurstLength__h18509, x__h15596, x_length__h17141;
  wire [13 : 0] IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d747,
		addr__h16703,
		b__h19141,
		mlp1B__h16687,
		mlp1__h16686;
  wire [11 : 0] bl__h17634, x_burstLength__h18615;
  wire [7 : 0] mesgMetaF_opcode__h16864;
  wire [3 : 0] b__h13989, x_byteEn__h18617;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h15499 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_2 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h18941 ;
  ...
  assign MUX_wmi_dhF_x_wire$wset_1__VAL_2 =
	     { 1'd1, x__h16771, wsiS_reqFifo$D_OUT[43:12], 4'd15 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { mesgMetaF_opcode__h16864, mesgMetaF_length__h17776 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd5, x__h18941, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  ...
  assign errCount$EN =
	     ...
	     (!x__h16771 || wsiS_reqFifo$D_OUT[11:8] != 4'd0) ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h19141) ? fabWordsRemain : b__h19141 ;
  ...
  // remaining internal signals
  assign IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d747 =
  ...
  assign NOT_wmi_reqF_c_r_46_EQ_2_47_48_AND_wmi_operate_ETC___d290 =
	     ...
	     (!x__h18941 || wmi_mFlagF_c_r != 2'd2) ;
  assign NOT_wsiS_reqFifo_countReg_53_ULE_1_54___d355 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign addr__h16703 = { mesgLengthSoFar[11:0], 2'd0 } ;
  assign b__h13989 = -fabWordsCurReq[3:0] ;
  assign b__h19141 = { {10{fabRespCredit_value[3]}}, fabRespCredit_value } ;
  assign bl__h17634 =
	     zeroLengthMesg ?
	       12'd1 :
	       IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d747[13:2] ;
  assign mesgMetaF_length__h16865 = { 10'd0, mlp1B__h16687 } ;
  assign mesgMetaF_length__h17776 =
	     { 10'd0,
	       IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d747 } ;
  assign mesgMetaF_opcode__h16864 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlp1B__h16687 = { mlp1__h16686[11:0], 2'd0 } ;
  assign mlp1__h16686 = MUX_mesgLengthSoFar$write_1__VAL_2 ;
  assign rdat__h15593 = { 16'd0, x__h15596 } ;
  assign wsiBurstLength__h18509 =
  ...
  assign x__h16771 = wsiS_reqFifo$D_OUT[55:44] == 12'd1 ;
  assign x__h18941 = fabWordsRemain == fabWordsCurReq ;
  assign x_burstLength__h18615 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h18509[11:0]) ;
  assign x_byteEn__h18617 = (thisMesg[15:0] == 16'd0) ? 4'd0 : 4'd15 ;
