...
//
// On Thu Jun 10 21:52:48 PDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCApp(RST_N_rst_0,
  ...
  wire [11 : 0] appW2$wmiM_MBurstLength,
		appW2$wsiM1_MBurstLength,
		appW2$wsiS1_MBurstLength;
  wire [7 : 0] appW2$wsiM1_MReqInfo, appW2$wsiS1_MReqInfo;
  ...
  wire appW2$wciS0_MAddrSpace,
       ...
       appW2$wsiM1_MBurstPrecise,
       appW2$wsiM1_MReqLast,
       appW2$wsiM1_MReset_n,
       appW2$wsiM1_SReset_n,
       appW2$wsiM1_SThreadBusy,
       appW2$wsiS1_MBurstPrecise,
       appW2$wsiS1_MReqLast,
       appW2$wsiS1_MReset_n,
       appW2$wsiS1_SReset_n,
       appW2$wsiS1_SThreadBusy;
  ...
  wire [11 : 0] appW3$wmemiM_MBurstLength,
		appW3$wsiM1_MBurstLength,
		appW3$wsiS1_MBurstLength;
  wire [7 : 0] appW3$wsiM1_MReqInfo, appW3$wsiS1_MReqInfo;
  wire [3 : 0] appW3$wciS0_MByteEn, appW3$wsiM1_MByteEn, appW3$wsiS1_MByteEn;
  ...
  wire appW3$wciS0_MAddrSpace,
       ...
       appW3$wsiM1_MBurstPrecise,
       appW3$wsiM1_MReqLast,
       appW3$wsiM1_MReset_n,
       appW3$wsiM1_SReset_n,
       appW3$wsiM1_SThreadBusy,
       appW3$wsiS1_MBurstPrecise,
       appW3$wsiS1_MReqLast,
       appW3$wsiS1_MReset_n,
       appW3$wsiS1_SReset_n,
       appW3$wsiS1_SThreadBusy;
  ...
  wire [11 : 0] appW4$wmiM_MBurstLength,
		appW4$wsiM1_MBurstLength,
		appW4$wsiS1_MBurstLength;
  wire [7 : 0] appW4$wsiM1_MReqInfo, appW4$wsiS1_MReqInfo;
  ...
  wire appW4$wciS0_MAddrSpace,
       ...
       appW4$wsiM1_MBurstPrecise,
       appW4$wsiM1_MReqLast,
       appW4$wsiM1_MReset_n,
       appW4$wsiM1_SReset_n,
       appW4$wsiM1_SThreadBusy,
       appW4$wsiS1_MBurstPrecise,
       appW4$wsiS1_MReqLast,
       appW4$wsiS1_MReset_n,
       appW4$wsiS1_SReset_n,
       appW4$wsiS1_SThreadBusy;
  ...
  // value method wsi_s_adc_sThreadBusy
  assign wsi_s_adc_SThreadBusy = appW2$wsiS1_SThreadBusy ;

  // value method wsi_s_adc_sReset_n
  assign wsi_s_adc_SReset_n = appW2$wsiS1_SReset_n ;
  ...
  // value method wsi_m_dac_mCmd
  assign wsi_m_dac_MCmd = appW4$wsiM1_MCmd ;

  // value method wsi_m_dac_mReqLast
  assign wsi_m_dac_MReqLast = appW4$wsiM1_MReqLast ;

  // value method wsi_m_dac_mBurstPrecise
  assign wsi_m_dac_MBurstPrecise = appW4$wsiM1_MBurstPrecise ;

  // value method wsi_m_dac_mBurstLength
  assign wsi_m_dac_MBurstLength = appW4$wsiM1_MBurstLength ;

  // value method wsi_m_dac_mData
  assign wsi_m_dac_MData = appW4$wsiM1_MData ;

  // value method wsi_m_dac_mByteEn
  assign wsi_m_dac_MByteEn = appW4$wsiM1_MByteEn ;

  // value method wsi_m_dac_mReqInfo
  assign wsi_m_dac_MReqInfo = appW4$wsiM1_MReqInfo ;
  ...
  // value method wsi_m_dac_mReset_n
  assign wsi_m_dac_MReset_n = appW4$wsiM1_MReset_n ;
  ...
  // submodule appW1
  /* Now in fpgaTop
  mkWCIExample4B  appW1(.wci_Clk				(CLK),
								.wci_MReset_n		(RST_N_rst_1),
								.wci_MAddr			(wci_s_1_MAddr),
								.wci_MAddrSpace	(wci_s_1_MAddrSpace),
								.wci_MByteEn		(wci_s_1_MByteEn),
								.wci_MCmd			(wci_s_1_MCmd),
								.wci_MData			(wci_s_1_MData),
								.wci_MFlag			(wci_s_1_MFlag),
								.wci_SResp			(wci_s_1_SResp),
								.wci_SData			(wci_s_1_SData),
								.wci_SThreadBusy	(wci_s_1_SThreadBusy),
								.wci_SFlag			(wci_s_1_SFlag) );
  */
  
  // submodule appW2
  mkSMAdapter4B #(.smaCtrlInit(32'h00000001)) appW2(.wciS0_Clk(CLK),
						    ...
						    .wsiS1_MBurstLength(appW2$wsiS1_MBurstLength),
						    .wsiS1_MByteEn(appW2$wsiS1_MByteEn),
						    .wsiS1_MCmd(appW2$wsiS1_MCmd),
						    .wsiS1_MData(appW2$wsiS1_MData),
						    .wsiS1_MReqInfo(appW2$wsiS1_MReqInfo),
						    ...
						    .wsiM1_SThreadBusy(appW2$wsiM1_SThreadBusy),
						    .wsiM1_SReset_n(appW2$wsiM1_SReset_n),
						    .wsiS1_MReqLast(appW2$wsiS1_MReqLast),
						    .wsiS1_MBurstPrecise(appW2$wsiS1_MBurstPrecise),
						    .wsiS1_MReset_n(appW2$wsiS1_MReset_n),
						    ...
						    .wsiM1_MCmd(appW2$wsiM1_MCmd),
						    .wsiM1_MReqLast(appW2$wsiM1_MReqLast),
						    .wsiM1_MBurstPrecise(appW2$wsiM1_MBurstPrecise),
						    .wsiM1_MBurstLength(appW2$wsiM1_MBurstLength),
						    .wsiM1_MData(appW2$wsiM1_MData),
						    .wsiM1_MByteEn(appW2$wsiM1_MByteEn),
						    .wsiM1_MReqInfo(appW2$wsiM1_MReqInfo),
						    .wsiM1_MReset_n(appW2$wsiM1_MReset_n),
						    .wsiS1_SThreadBusy(appW2$wsiS1_SThreadBusy),
						    .wsiS1_SReset_n(appW2$wsiS1_SReset_n));

  // submodule appW3
  mkDelayWorker4B #(.dlyCtrlInit(32'h0)) appW3(.wciS0_Clk(CLK),
					       ...
					       .wsiS1_MBurstLength(appW3$wsiS1_MBurstLength),
					       .wsiS1_MByteEn(appW3$wsiS1_MByteEn),
					       .wsiS1_MCmd(appW3$wsiS1_MCmd),
					       .wsiS1_MData(appW3$wsiS1_MData),
					       .wsiS1_MReqInfo(appW3$wsiS1_MReqInfo),
					       .wsiS1_MReqLast(appW3$wsiS1_MReqLast),
					       .wsiS1_MBurstPrecise(appW3$wsiS1_MBurstPrecise),
					       .wsiS1_MReset_n(appW3$wsiS1_MReset_n),
					       .wsiM1_SThreadBusy(appW3$wsiM1_SThreadBusy),
					       .wsiM1_SReset_n(appW3$wsiM1_SReset_n),
					       ...
					       .wsiS1_SThreadBusy(appW3$wsiS1_SThreadBusy),
					       .wsiS1_SReset_n(appW3$wsiS1_SReset_n),
					       .wsiM1_MCmd(appW3$wsiM1_MCmd),
					       .wsiM1_MReqLast(appW3$wsiM1_MReqLast),
					       .wsiM1_MBurstPrecise(appW3$wsiM1_MBurstPrecise),
					       .wsiM1_MBurstLength(appW3$wsiM1_MBurstLength),
					       .wsiM1_MData(appW3$wsiM1_MData),
					       .wsiM1_MByteEn(appW3$wsiM1_MByteEn),
					       .wsiM1_MReqInfo(appW3$wsiM1_MReqInfo),
					       .wsiM1_MReset_n(appW3$wsiM1_MReset_n),
  ...
  // submodule appW4
  mkSMAdapter4B #(.smaCtrlInit(32'h00000002)) appW4(.wciS0_Clk(CLK),
						    ...
						    .wsiS1_MBurstLength(appW4$wsiS1_MBurstLength),
						    .wsiS1_MByteEn(appW4$wsiS1_MByteEn),
						    .wsiS1_MCmd(appW4$wsiS1_MCmd),
						    .wsiS1_MData(appW4$wsiS1_MData),
						    .wsiS1_MReqInfo(appW4$wsiS1_MReqInfo),
						    ...
						    .wsiM1_SThreadBusy(appW4$wsiM1_SThreadBusy),
						    .wsiM1_SReset_n(appW4$wsiM1_SReset_n),
						    .wsiS1_MReqLast(appW4$wsiS1_MReqLast),
						    .wsiS1_MBurstPrecise(appW4$wsiS1_MBurstPrecise),
						    .wsiS1_MReset_n(appW4$wsiS1_MReset_n),
						    ...
						    .wsiM1_MCmd(appW4$wsiM1_MCmd),
						    .wsiM1_MReqLast(appW4$wsiM1_MReqLast),
						    .wsiM1_MBurstPrecise(appW4$wsiM1_MBurstPrecise),
						    .wsiM1_MBurstLength(appW4$wsiM1_MBurstLength),
						    .wsiM1_MData(appW4$wsiM1_MData),
						    .wsiM1_MByteEn(appW4$wsiM1_MByteEn),
						    .wsiM1_MReqInfo(appW4$wsiM1_MReqInfo),
						    .wsiM1_MReset_n(appW4$wsiM1_MReset_n),
						    .wsiS1_SThreadBusy(appW4$wsiS1_SThreadBusy),
						    .wsiS1_SReset_n(appW4$wsiS1_SReset_n));

  // rule RL_sRstConnect_1
  assign CAN_FIRE_RL_sRstConnect_1 = appW4$wsiS1_SReset_n ;
  assign WILL_FIRE_RL_sRstConnect_1 = appW4$wsiS1_SReset_n ;

  // rule RL_mRstConnect_1
  assign CAN_FIRE_RL_mRstConnect_1 = appW3$wsiM1_MReset_n ;
  assign WILL_FIRE_RL_mRstConnect_1 = appW3$wsiM1_MReset_n ;

  // rule RL_stbConnect_1
  assign CAN_FIRE_RL_stbConnect_1 = appW4$wsiS1_SThreadBusy ;
  assign WILL_FIRE_RL_stbConnect_1 = appW4$wsiS1_SThreadBusy ;
  ...
  assign CAN_FIRE_RL_mBurstPConnect_1 = appW3$wsiM1_MBurstPrecise ;
  assign WILL_FIRE_RL_mBurstPConnect_1 = appW3$wsiM1_MBurstPrecise ;

  // rule RL_mReqLConnect_1
  assign CAN_FIRE_RL_mReqLConnect_1 = appW3$wsiM1_MReqLast ;
  assign WILL_FIRE_RL_mReqLConnect_1 = appW3$wsiM1_MReqLast ;
  ...
  // rule RL_sRstConnect
  assign CAN_FIRE_RL_sRstConnect = appW3$wsiS1_SReset_n ;
  assign WILL_FIRE_RL_sRstConnect = appW3$wsiS1_SReset_n ;

  // rule RL_stbConnect
  assign CAN_FIRE_RL_stbConnect = appW3$wsiS1_SThreadBusy ;
  assign WILL_FIRE_RL_stbConnect = appW3$wsiS1_SThreadBusy ;

  // rule RL_mRstConnect
  assign CAN_FIRE_RL_mRstConnect = appW2$wsiM1_MReset_n ;
  assign WILL_FIRE_RL_mRstConnect = appW2$wsiM1_MReset_n ;
  ...
  assign CAN_FIRE_RL_mBurstPConnect = appW2$wsiM1_MBurstPrecise ;
  assign WILL_FIRE_RL_mBurstPConnect = appW2$wsiM1_MBurstPrecise ;

  // rule RL_mReqLConnect
  assign CAN_FIRE_RL_mReqLConnect = appW2$wsiM1_MReqLast ;
  assign WILL_FIRE_RL_mReqLConnect = appW2$wsiM1_MReqLast ;
  ...
  assign appW2$wsiS1_MByteEn = wsi_s_adc_MByteEn ;
  assign appW2$wsiS1_MBurstLength = wsi_s_adc_MBurstLength ;
  assign appW2$wsiS1_MCmd = wsi_s_adc_MCmd ;
  assign appW2$wsiS1_MData = wsi_s_adc_MData ;
  assign appW2$wsiS1_MReqInfo = wsi_s_adc_MReqInfo ;
  ...
  assign appW2$wsiM1_SThreadBusy = appW3$wsiS1_SThreadBusy ;
  assign appW2$wsiM1_SReset_n = appW3$wsiS1_SReset_n ;
  assign appW2$wsiS1_MBurstPrecise = wsi_s_adc_MBurstPrecise ;
  assign appW2$wsiS1_MReqLast = wsi_s_adc_MReqLast ;
  assign appW2$wsiS1_MReset_n = wsi_s_adc_MReset_n ;
  ...
  assign appW3$wsiS1_MByteEn = appW2$wsiM1_MByteEn ;
  assign appW3$wsiS1_MBurstLength = appW2$wsiM1_MBurstLength ;
  assign appW3$wsiS1_MCmd = appW2$wsiM1_MCmd ;
  assign appW3$wsiS1_MData = appW2$wsiM1_MData ;
  assign appW3$wsiS1_MReqInfo = appW2$wsiM1_MReqInfo ;
  assign appW3$wmemiM_SCmdAccept = wmemiM_SCmdAccept ;
  assign appW3$wmemiM_SDataAccept = wmemiM_SDataAccept ;
  assign appW3$wsiM1_SReset_n = appW4$wsiS1_SReset_n ;
  assign appW3$wmemiM_SRespLast = wmemiM_SRespLast ;
  assign appW3$wsiM1_SThreadBusy = appW4$wsiS1_SThreadBusy ;
  assign appW3$wsiS1_MBurstPrecise = appW2$wsiM1_MBurstPrecise ;
  assign appW3$wsiS1_MReqLast = appW2$wsiM1_MReqLast ;
  assign appW3$wsiS1_MReset_n = appW2$wsiM1_MReset_n ;
  ...
  assign appW4$wsiS1_MBurstLength = appW3$wsiM1_MBurstLength ;
  assign appW4$wmiM_SResp = wmiM1_SResp ;
  assign appW4$wsiS1_MByteEn = appW3$wsiM1_MByteEn ;
  assign appW4$wsiS1_MCmd = appW3$wsiM1_MCmd ;
  assign appW4$wsiS1_MData = appW3$wsiM1_MData ;
  assign appW4$wsiS1_MReqInfo = appW3$wsiM1_MReqInfo ;
  ...
  assign appW4$wsiM1_SReset_n = wsi_m_dac_SReset_n ;
  assign appW4$wsiM1_SThreadBusy = wsi_m_dac_SThreadBusy ;
  assign appW4$wsiS1_MBurstPrecise = appW3$wsiM1_MBurstPrecise ;
  assign appW4$wsiS1_MReset_n = appW3$wsiM1_MReset_n ;
  assign appW4$wsiS1_MReqLast = appW3$wsiM1_MReqLast ;
endmodule  // mkOCApp
