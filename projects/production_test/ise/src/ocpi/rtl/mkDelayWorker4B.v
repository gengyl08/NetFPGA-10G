...
//
// On Thu Jun 10 21:51:59 PDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  wire [31 : 0] mesgRF_wDataIn$wget,
		mesgRF_wDataOut$wget,
		mesgWF_wDataIn$wget,
		mesgWF_wDataOut$wget,
		wci_Es_mData_w$wget,
		wsi_Es_mData_w$wget;
  wire [19 : 0] dlyWordsStored_acc_v1$wget,
		dlyWordsStored_acc_v2$wget,
		wci_Es_mAddr_w$wget;
  ...
  reg [43 : 0] mesgRF_rCache;
  wire [43 : 0] mesgRF_rCache$D_IN;
  ...
  wire [31 : 0] mesgRF_memory$DIA, mesgRF_memory$DIB, mesgRF_memory$DOB;
  ...
  wire [9 : 0] mesgWF_memory$ADDRA, mesgWF_memory$ADDRB;
  ...
  wire [19 : 0] MUX_dlyRAG$write_1__VAL_1,
  ...
  reg [63 : 0] v__h17604,
	       ...
	       v__h2828,
	       v__h3728;
  reg [31 : 0] sendData__h23482, x_data__h21857;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      IF_wrtSerPos_10_EQ_0_11_OR_wrtSerPos_10_EQ_1_1_ETC___d1006;
  wire [127 : 0] IF_wrtSerPos_10_EQ_2_13_THEN_0x0_ELSE_mesgWF_w_ETC___d352,
		 IF_wrtSerPos_10_EQ_2_13_THEN_0x0_ELSE_metaWF_f_ETC___d375,
		 x1__h20010,
		 x1__h20019,
		 x1__h20539,
		 x1__h20548;
  wire [35 : 0] addr__h21047, addr__h21219;
  wire [31 : 0] data__h19663,
		mesg__h22399,
		rdat__h21900,
		rdat__h22083,
		rdat__h22091,
		...
		x__h15276,
		x__h16202;
  wire [23 : 0] x1_length__h17297, x__h21105, x__h21264, x__h21903;
  wire [13 : 0] mlp1__h17996, x__h17341;
  wire [11 : 0] x_burstLength__h22490;
  wire [10 : 0] x__h15168, x__h16094;
  wire [7 : 0] x1_opcode__h17296;
  wire [3 : 0] x_byteEn__h22491;
  wire [1 : 0] wrtSerPos_10_PLUS_1___d943;
  wire NOT_dlyWordsStored_value_13_SLE_0_63_64_AND_NO_ETC___d271,
       NOT_mesgRF_rRdPtr_52_PLUS_512_93_EQ_mesgRF_rWr_ETC___d208,
       NOT_wsiS_reqFifo_countReg_93_ULE_1_94___d695,
       _dor1bytesWritten$EN_write,
       metaRF_RDY_enq__40_AND_NOT_rdSerEmpty_96_97_AN_ETC___d241,
       metaWF_RDY_deq__56_AND_NOT_wrtSerPos_10_EQ_3_1_ETC___d363,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d395;
  ...
  BRAM2 #(.PIPELINED(1'd0),
	  .ADDR_WIDTH(32'd10),
	  .DATA_WIDTH(32'd32),
	  .MEMSIZE(11'd1024)) mesgWF_memory(.CLKA(wciS0_Clk),
					    .CLKB(wciS0_Clk),
  ...
  assign CAN_FIRE_RL_delay_read_req =
	     ...
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     NOT_dlyWordsStored_value_13_SLE_0_63_64_AND_NO_ETC___d271 &&
  ...
  assign CAN_FIRE_RL_wmwt_messagePushPrecise =
	     mesgWF_rRdPtr + 11'd512 != mesgWF_rWrPtr &&
	     wsiS_reqFifo$EMPTY_N &&
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
  ...
  assign MUX_dlyRAG$write_1__VAL_1 = dlyRAG + 20'd1 ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && sendData__h23482[23:0] == 24'd0 ;
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_10_EQ_2_13_THEN_0x0_ELSE_metaWF_f_ETC___d375 or
	  x1__h20539 or x1__h20548)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h20539;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h20548;
      default: MUX_wide16Fa$enq_1__VAL_1 =
		   IF_wrtSerPos_10_EQ_2_13_THEN_0x0_ELSE_metaWF_f_ETC___d375;
    endcase
  end
  always@(wrtSerPos or
	  IF_wrtSerPos_10_EQ_2_13_THEN_0x0_ELSE_mesgWF_w_ETC___d352 or
	  x1__h20010 or x1__h20019)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h20010;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h20019;
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_10_EQ_2_13_THEN_0x0_ELSE_mesgWF_w_ETC___d352;
    endcase
  end
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h21047, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h21219, 12'd1 } ;
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_10_PLUS_1___d943 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_10_PLUS_1___d943 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h21857 } ;
  ...
  assign mesgWF_wDataOut$wget = data__h19663 ;
  ...
  assign mesgRF_wDataIn$wget = sendData__h23482 ;
  assign mesgRF_wDataIn$whas = CAN_FIRE_RL_rdSer_body ;
  assign mesgRF_wDataOut$wget = mesg__h22399 ;
  assign mesgRF_wDataOut$whas = 1'd1 ;
  assign dlyWordsStored_acc_v1$wget = 20'd1 ;
  assign dlyWordsStored_acc_v1$whas = CAN_FIRE_RL_delay_write_req ;
  assign dlyWordsStored_acc_v2$wget = 20'd1048575 ;
  ...
  // register dlyRAG
  assign dlyRAG$D_IN =
	     WILL_FIRE_RL_delay_read_req ? MUX_dlyRAG$write_1__VAL_1 : 20'd0 ;
  assign dlyRAG$EN =
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_2 ? 14'd0 : mlp1__h17996 ;
  assign mesgLengthSoFar$EN =
	     WILL_FIRE_RL_wmwt_mesgBegin && !wsiS_reqFifo$D_OUT[56] ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;

  // register mesgRF_rCache
  assign mesgRF_rCache$D_IN = { 1'd1, mesgRF_rWrPtr, x__h16202 } ;
  assign mesgRF_rCache$EN = CAN_FIRE_RL_rdSer_body ;

  // register mesgRF_rRdPtr
  assign mesgRF_rRdPtr$D_IN = x__h16094 ;
  ...
  // register mesgWF_rCache
  assign mesgWF_rCache$D_IN = { 1'd1, mesgWF_rWrPtr, x__h15276 } ;
  assign mesgWF_rCache$EN = mesgWF_pwEnqueue$whas ;

  // register mesgWF_rRdPtr
  assign mesgWF_rRdPtr$D_IN = x__h15168 ;
  assign mesgWF_rRdPtr$EN = CAN_FIRE_RL_wrtSer_body ;

  // register mesgWF_rWrPtr
  assign mesgWF_rWrPtr$D_IN = mesgWF_rWrPtr + 11'd1 ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = sendData__h23482 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h19663 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h19663 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h19663 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wrtSerStage_3$write_1__SEL_1 ? data__h19663 : metaWF$D_OUT ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_10_EQ_2_13_THEN_0x0_ELSE_mesgWF_w_ETC___d352 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h19663,
	       (wrtSerPos == 2'd2) ? data__h19663 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_10_EQ_2_13_THEN_0x0_ELSE_metaWF_f_ETC___d375 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : metaWF$D_OUT,
	       (wrtSerPos == 2'd2) ? metaWF$D_OUT : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign NOT_dlyWordsStored_value_13_SLE_0_63_64_AND_NO_ETC___d271 =
	     (dlyWordsStored_value ^ 20'h80000) > 20'd524288 &&
  ...
  assign NOT_wsiS_reqFifo_countReg_93_ULE_1_94___d695 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h21047 = { 12'd0, x__h21105 } ;
  assign addr__h21219 = { 12'd0, x__h21264 } ;
  assign data__h19663 =
	     (mesgWF_rCache[43] && mesgWF_rCache[42:32] == mesgWF_rRdPtr) ?
	       mesgWF_rCache[31:0] :
	       mesgWF_memory$DOB ;
  assign mesg__h22399 =
	     (mesgRF_rCache[43] && mesgRF_rCache[42:32] == mesgRF_rRdPtr) ?
	       mesgRF_rCache[31:0] :
	       mesgRF_memory$DOB ;
  assign metaRF_RDY_enq__40_AND_NOT_rdSerEmpty_96_97_AN_ETC___d241 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign metaWF_RDY_deq__56_AND_NOT_wrtSerPos_10_EQ_3_1_ETC___d363 =
	     metaWF$EMPTY_N &&
	     (wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	      IF_wrtSerPos_10_EQ_0_11_OR_wrtSerPos_10_EQ_1_1_ETC___d1006) ;
  assign mlp1__h17996 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h21900 = { 8'd0, x__h21903 } ;
  assign rdat__h22083 = { 12'd0, dlyWordsStored_value } ;
  assign rdat__h22091 = { 24'd0, dlyReadCredit_value } ;
  assign rdat__h22099 = { 12'd0, dlyWAG } ;
  assign rdat__h22107 = { 12'd0, dlyRAG } ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d395 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 && mesgLength[14] &&
	     !doAbort &&
	     (preciseBurst && wsiWordsRemain == 12'd0 ||
	      impreciseBurst && endOfMessage) ;
  assign wrtSerPos_10_PLUS_1___d943 = wrtSerPos + 2'd1 ;
  assign x1__h20010 = { 96'd0, data__h19663 } ;
  assign x1__h20019 = { 64'd0, data__h19663, wrtSerStage } ;
  assign x1__h20539 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h20548 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  assign x1_length__h17297 = { 10'd0, x__h17341 } ;
  assign x1_opcode__h17296 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h15168 = mesgWF_rRdPtr + 11'd1 ;
  assign x__h15276 =
	     mesgWF_pwEnqueue$whas ? wsiS_reqFifo$D_OUT[43:12] : 32'd0 ;
  assign x__h16094 = mesgRF_rRdPtr + 11'd1 ;
  assign x__h16202 = CAN_FIRE_RL_rdSer_body ? sendData__h23482 : 32'd0 ;
  assign x__h17341 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h21105 = { dlyRAG, 4'h0 } ;
  assign x__h21264 = { dlyWAG, 4'h0 } ;
  assign x__h21903 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h22490 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h22491 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(rdSerPos or
	  rdSerStage_3 or wide16Fb$D_OUT or rdSerStage_1 or rdSerStage_2)
  begin
    case (rdSerPos)
      2'd0: sendData__h23482 = wide16Fb$D_OUT[31:0];
      2'd1: sendData__h23482 = rdSerStage_1;
      2'd2: sendData__h23482 = rdSerStage_2;
      2'd3: sendData__h23482 = rdSerStage_3;
    endcase
  end
  ...
  always@(wci_reqF$D_OUT or
	  ...
	  wmemiRdReq or
	  wmemiRdResp or
	  rdat__h22083 or rdat__h22091 or rdat__h22099 or rdat__h22107)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h21857 = dlyCtrl;
      20'h00004: x_data__h21857 = dlyHoldoffBytes;
      20'h00008: x_data__h21857 = dlyHoldoffCycles;
      20'h0000C: x_data__h21857 = mesgWtCount;
      20'h00010: x_data__h21857 = mesgRdCount;
      20'h00014: x_data__h21857 = bytesWritten;
      20'h00018: x_data__h21857 = rdat__h21900;
      20'h0001C: x_data__h21857 = 32'd0;
      20'h00020: x_data__h21857 = wsiS_extStatusW$wget[95:64];
      20'h00024: x_data__h21857 = wsiS_extStatusW$wget[63:32];
      20'h00028: x_data__h21857 = wsiS_extStatusW$wget[31:0];
      20'h0002C: x_data__h21857 = wsiM_extStatusW$wget[95:64];
      20'h00030: x_data__h21857 = wsiM_extStatusW$wget[63:32];
      20'h00034: x_data__h21857 = wsiM_extStatusW$wget[31:0];
      20'h00038: x_data__h21857 = wmemiWrReq;
      20'h0003C: x_data__h21857 = wmemiRdReq;
      20'h00040: x_data__h21857 = wmemiRdResp;
      20'h00044: x_data__h21857 = rdat__h22083;
      20'h00048: x_data__h21857 = rdat__h22091;
      20'h0004C: x_data__h21857 = rdat__h22099;
      20'h00050: x_data__h21857 = rdat__h22107;
      default: x_data__h21857 = 32'd0;
    endcase
  end
  ...
  begin
	...
	dlyRAG <= `BSV_ASSIGNMENT_DELAY 20'd0;
	dlyReadCredit_value <= `BSV_ASSIGNMENT_DELAY 8'd0;
	dlyWAG <= `BSV_ASSIGNMENT_DELAY 20'd0;
	dlyWordsStored_value <= `BSV_ASSIGNMENT_DELAY 20'd0;
	...
	mesgRF_rCache <= `BSV_ASSIGNMENT_DELAY 44'h2AAAAAAAAAA;
	...
	mesgWF_rCache <= `BSV_ASSIGNMENT_DELAY 44'h2AAAAAAAAAA;
	mesgWF_rRdPtr <= `BSV_ASSIGNMENT_DELAY 11'd0;
	mesgWF_rWrPtr <= `BSV_ASSIGNMENT_DELAY 11'd0;
  ...
  begin
    ...
    dlyWAG = 20'hAAAAA;
    dlyWordsStored_value = 20'hAAAAA;
    doAbort = 1'h0;
    endOfMessage = 1'h0;
    ...
    mesgRF_rCache = 44'hAAAAAAAAAAA;
    mesgRF_rRdPtr = 11'h2AA;
    mesgRF_rWrPtr = 11'h2AA;
    mesgRdCount = 32'hAAAAAAAA;
    mesgReqValid = 1'h0;
    mesgWF_rCache = 44'hAAAAAAAAAAA;
    mesgWF_rRdPtr = 11'h2AA;
    mesgWF_rWrPtr = 11'h2AA;
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h17849);
    if (wciS0_MReset_n)
