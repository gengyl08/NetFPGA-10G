...
//
// On Thu Jun 10 21:52:36 PDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter32B(wciS0_Clk,
  ...
  wire [31 : 0] rdat__h15593, x_byteEn__h18619;
  ...
  assign MUX_wmi_dhF_x_wire$wset_1__VAL_2 =
	     { 1'd1, x__h16771, wsiS_reqFifo$D_OUT[295:40], 32'hFFFFFFFF } ;
  ...
  assign errCount$EN =
	     ...
	     (!x__h16771 || wsiS_reqFifo$D_OUT[39:8] != 32'd0) ;
  ...
  assign NOT_wsiS_reqFifo_countReg_56_ULE_1_57___d358 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign addr__h16703 = { mesgLengthSoFar[8:0], 5'd0 } ;
  ...
  assign bl__h17634 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 3'd0,
		 IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d750[13:5] } ;
  ...
  assign mlp1B__h16687 = { mlp1__h16686[8:0], 5'd0 } ;
  ...
  assign x__h16771 = wsiS_reqFifo$D_OUT[307:296] == 12'd1 ;
  ...
  assign x_byteEn__h18619 = (thisMesg[15:0] == 16'd0) ? 32'd0 : 32'hFFFFFFFF ;
