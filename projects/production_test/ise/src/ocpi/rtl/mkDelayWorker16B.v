...
//
// On Thu Jun 10 21:52:08 PDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker16B(wciS0_Clk,
			wciS0_MReset_n,
  ...
  wire [127 : 0] wmemiM_MData, wsiM1_MData;
  wire [35 : 0] wmemiM_MAddr;
  wire [31 : 0] wciS0_SData;
  wire [15 : 0] wmemiM_MDataByteEn, wsiM1_MByteEn;
  ...
  wire [127 : 0] mesgRF_wDataIn$wget,
  ...
  reg [139 : 0] mesgRF_rCache;
  wire [139 : 0] mesgRF_rCache$D_IN;
  ...
  reg [139 : 0] mesgWF_rCache;
  wire [139 : 0] mesgWF_rCache$D_IN;
  ...
  wire [127 : 0] mesgRF_memory$DIA, mesgRF_memory$DIB, mesgRF_memory$DOB;
  ...
  // value method wsiM1_mCmd
  assign wsiM1_MCmd = wsiM_sThreadBusy_d ? 3'd0 : wsiM_reqFifo_q_0[168:166] ;

  // value method wsiM1_mReqLast
  assign wsiM1_MReqLast = !wsiM_sThreadBusy_d && wsiM_reqFifo_q_0[165] ;

  // value method wsiM1_mBurstPrecise
  assign wsiM1_MBurstPrecise = !wsiM_sThreadBusy_d && wsiM_reqFifo_q_0[164] ;
  ...
  // value method wsiM1_mData
  assign wsiM1_MData = wsiM_reqFifo_q_0[151:24] ;

  // value method wsiM1_mByteEn
  assign wsiM1_MByteEn = wsiM_reqFifo_q_0[23:8] ;
  ...
  assign MUX_mesgLength$write_1__VAL_2 =
	     (wsiS_reqFifo$D_OUT[23:8] == 16'd0) ?
	       15'd16384 :
	       { 1'd1, wsiS_reqFifo$D_OUT[161:152], 4'd0 } ;
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17996[9:0], 4'd0 } ;
  ...
  assign MUX_endOfMessage$write_1__SEL_1 =
	     WILL_FIRE_RL_wmwt_messagePushImprecise &&
	     wsiS_reqFifo$D_OUT[163:152] == 12'd1 ;
  assign MUX_impreciseBurst$write_1__SEL_2 =
	     WILL_FIRE_RL_wmwt_mesgBegin && !wsiS_reqFifo$D_OUT[164] ;
  ...
  assign mesgWF_wDataOut$wget =
	     (mesgWF_rCache[139] && mesgWF_rCache[138:128] == mesgWF_rRdPtr) ?
	       mesgWF_rCache[127:0] :
	       mesgWF_memory$DOB ;
  ...
  assign mesgRF_wDataOut$wget =
	     (mesgRF_rCache[139] && mesgRF_rCache[138:128] == mesgRF_rRdPtr) ?
	       mesgRF_rCache[127:0] :
	       mesgRF_memory$DOB ;
  ...
  assign mesgRF_wDataIn$wget = { 96'd0, v__h22774 } ;
  ...
  // register errCount
  assign errCount$D_IN = errCount + 128'd1 ;
  assign errCount$EN =
	     WILL_FIRE_RL_wmwt_messagePushImprecise &&
	     wsiS_reqFifo$D_OUT[151:24] != valExpect &&
	     (wsiS_reqFifo$D_OUT[163:152] != 12'd1 ||
	      wsiS_reqFifo$D_OUT[23:8] != 16'd0) ;
  ...
  assign wsiM_burstKind$EN =
	     ...
	     (wsiM_burstKind == 2'd0 ||
	      wsiM_burstKind == 2'd1 && wsiM_reqFifo_q_0[165] ||
	      wsiM_burstKind == 2'd2 && wsiM_reqFifo_q_0[163:152] == 12'd1) ;
  ...
  assign wsiM_iMesgCount$EN =
	     ...
	     wsiM_reqFifo_q_0[168:166] == 3'd1 &&
	     wsiM_burstKind == 2'd2 &&
	     wsiM_reqFifo_q_0[163:152] == 12'd1 ;
  ...
  // register zeroLengthMesg
  assign zeroLengthMesg$D_IN = wsiS_reqFifo$D_OUT[23:8] == 16'd0 ;
  ...
  assign x__h15276 =
	     mesgWF_pwEnqueue$whas ? wsiS_reqFifo$D_OUT[151:24] : 128'd0 ;
  assign x__h16094 = mesgRF_rRdPtr + 11'd1 ;
  assign x__h16202 = CAN_FIRE_RL_rdSer_body ? mesgRF_wDataIn$wget : 128'd0 ;
  ...
  assign x_byteEn__h22492 = (readMeta[23:0] == 24'd0) ? 16'd0 : 16'd65535 ;
  ...
  begin
    ...
    mesgRF_rCache = 140'hAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;
    mesgRF_rRdPtr = 11'h2AA;
    mesgRF_rWrPtr = 11'h2AA;
    mesgRdCount = 32'hAAAAAAAA;
    mesgReqValid = 1'h0;
    mesgWF_rCache = 140'hAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_mesgBegin && wsiS_reqFifo$D_OUT[164])
	begin
	  v__h19158 = $time;
	  #0;
	end
