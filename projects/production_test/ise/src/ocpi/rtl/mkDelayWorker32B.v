...
//
// On Thu Jun 10 21:52:13 PDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker32B(wciS0_Clk,
  ...
  wire [255 : 0] mesg__h22400, x__h15276, x__h16202, x__h19947;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17996[8:0], 5'd0 } ;
  ...
  assign mesgRF_wDataIn$wget = { 224'd0, v__h22774 } ;
  ...
  assign x__h16202 = CAN_FIRE_RL_rdSer_body ? mesgRF_wDataIn$wget : 256'd0 ;
  ...
  assign x_byteEn__h22492 = (readMeta[23:0] == 24'd0) ? 32'd0 : 32'hFFFFFFFF ;
