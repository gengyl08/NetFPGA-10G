...
//
// On Thu Jun 10 21:52:04 PDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
		       wciS0_MReset_n,
  ...
  reg [75 : 0] mesgRF_rCache;
  wire [75 : 0] mesgRF_rCache$D_IN;
  ...
  reg [75 : 0] mesgWF_rCache;
  wire [75 : 0] mesgWF_rCache$D_IN;
  ...
  wire [63 : 0] mesgRF_memory$DIA, mesgRF_memory$DIB, mesgRF_memory$DOB;
  ...
  reg [63 : 0] v__h17604,
	       ...
	       v__h2828,
	       v__h3728;
  reg [31 : 0] x_data__h21858;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      IF_wrtSerPos_11_EQ_0_12_OR_wrtSerPos_11_EQ_1_1_ETC___d979;
  wire [127 : 0] IF_wrtSerPos_11_EQ_2_14_THEN_0x0_ELSE_mesgWF_w_ETC___d354,
		 ...
		 x1__h20540,
		 x1__h20549;
  wire [63 : 0] mesg__h22400, x__h15276, x__h16202, x__h19947;
  wire [35 : 0] addr__h21048, addr__h21220;
  wire [31 : 0] rdat__h21901,
		rdat__h22084,
		rdat__h22092,
		rdat__h22100,
		rdat__h22108,
		v__h22774;
  wire [23 : 0] x1_length__h17297, x__h21106, x__h21265, x__h21904;
  wire [13 : 0] mlp1__h17996, x__h17341;
  wire [11 : 0] x_burstLength__h22491;
  wire [10 : 0] x__h15168, x__h16094;
  wire [7 : 0] x1_opcode__h17296, x_byteEn__h22492;
  wire [1 : 0] wrtSerPos_11_PLUS_1___d1010;
  ...
  // value method wsiM1_mCmd
  assign wsiM1_MCmd = wsiM_sThreadBusy_d ? 3'd0 : wsiM_reqFifo_q_0[96:94] ;

  // value method wsiM1_mReqLast
  assign wsiM1_MReqLast = !wsiM_sThreadBusy_d && wsiM_reqFifo_q_0[93] ;

  // value method wsiM1_mBurstPrecise
  assign wsiM1_MBurstPrecise = !wsiM_sThreadBusy_d && wsiM_reqFifo_q_0[92] ;
  ...
  // value method wsiM1_mData
  assign wsiM1_MData = wsiM_reqFifo_q_0[79:16] ;

  // value method wsiM1_mByteEn
  assign wsiM1_MByteEn = wsiM_reqFifo_q_0[15:8] ;
  ...
  assign MUX_mesgLength$write_1__VAL_2 =
	     (wsiS_reqFifo$D_OUT[15:8] == 8'd0) ?
	       15'd16384 :
	       { 1'd1, wsiS_reqFifo$D_OUT[90:80], 3'd0 } ;
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17996[10:0], 3'd0 } ;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h21048, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h21220, 12'd1 } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h21858 } ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && v__h22774[23:0] == 24'd0 ;
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_1 =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       1'd1,
	       x_burstLength__h22491,
	       mesg__h22400,
	       x_byteEn__h22492,
	       readMeta[31:24] } ;
  ...
  always@(wrtSerPos or
	  ...
	  x1__h20011 or x1__h20020)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h20011;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h20020;
  ...
  always@(wrtSerPos or
	  ...
	  x1__h20540 or x1__h20549)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h20540;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h20549;
      default: MUX_wide16Fa$enq_1__VAL_1 =
		   IF_wrtSerPos_11_EQ_2_14_THEN_0x0_ELSE_metaWF_f_ETC___d377;
    endcase
  end
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_11_PLUS_1___d1010 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_11_PLUS_1___d1010 ;
  assign MUX_endOfMessage$write_1__SEL_1 =
	     WILL_FIRE_RL_wmwt_messagePushImprecise &&
	     wsiS_reqFifo$D_OUT[91:80] == 12'd1 ;
  assign MUX_impreciseBurst$write_1__SEL_2 =
	     WILL_FIRE_RL_wmwt_mesgBegin && !wsiS_reqFifo$D_OUT[92] ;
  ...
  assign mesgWF_wDataOut$wget =
	     (mesgWF_rCache[75] && mesgWF_rCache[74:64] == mesgWF_rRdPtr) ?
	       mesgWF_rCache[63:0] :
	       mesgWF_memory$DOB ;
  ...
  assign mesgRF_wDataOut$wget =
	     (mesgRF_rCache[75] && mesgRF_rCache[74:64] == mesgRF_rRdPtr) ?
	       mesgRF_rCache[63:0] :
	       mesgRF_memory$DOB ;
  ...
  assign mesgRF_wDataIn$wget = { 32'd0, v__h22774 } ;
  ...
  // register errCount
  assign errCount$D_IN = errCount + 64'd1 ;
  assign errCount$EN =
	     WILL_FIRE_RL_wmwt_messagePushImprecise &&
	     wsiS_reqFifo$D_OUT[79:16] != valExpect &&
	     (wsiS_reqFifo$D_OUT[91:80] != 12'd1 ||
	      wsiS_reqFifo$D_OUT[15:8] != 8'd0) ;
  ...
  // register valExpect
  assign valExpect$D_IN = valExpect + 64'd1 ;
  assign valExpect$EN =
	     WILL_FIRE_RL_wmwt_messagePushImprecise &&
	     (wsiS_reqFifo$D_OUT[91:80] != 12'd1 ||
	      wsiS_reqFifo$D_OUT[15:8] != 8'd0) ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h19947[31:0] : metaWF$D_OUT ;
  ...
  assign wsiM_burstKind$EN =
	     ...
	     (wsiM_burstKind == 2'd0 ||
	      wsiM_burstKind == 2'd1 && wsiM_reqFifo_q_0[93] ||
	      wsiM_burstKind == 2'd2 && wsiM_reqFifo_q_0[91:80] == 12'd1) ;
  ...
  assign wsiS_burstKind$EN =
	     WILL_FIRE_RL_wsiS_reqFifo_enq &&
	     (wsiS_burstKind == 2'd0 ||
	      wsiS_burstKind == 2'd1 && wsiS_wsiReq$wget[93] ||
	      wsiS_burstKind == 2'd2 && wsiS_wsiReq$wget[91:80] == 12'd1) ;
  ...
  // register zeroLengthMesg
  assign zeroLengthMesg$D_IN = wsiS_reqFifo$D_OUT[15:8] == 8'd0 ;
  ...
  assign mesgRF_memory$ADDRB =
	     CAN_FIRE_RL_wmrd_mesgBodyResponse ?
	       x__h16094[9:0] :
	       mesgRF_rRdPtr[9:0] ;
  assign mesgRF_memory$DIB = 64'hAAAAAAAAAAAAAAAA /* unspecified value */  ;
  ...
  assign IF_wrtSerPos_11_EQ_2_14_THEN_0x0_ELSE_mesgWF_w_ETC___d354 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h19947[31:0],
	       (wrtSerPos == 2'd2) ? x__h19947[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  ...
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h21048 = { 12'd0, x__h21106 } ;
  assign addr__h21220 = { 12'd0, x__h21265 } ;
  assign mesg__h22400 = mesgRF_wDataOut$wget ;
  ...
  assign rdat__h21901 = { 8'd0, x__h21904 } ;
  assign rdat__h22084 = { 12'd0, dlyWordsStored_value } ;
  assign rdat__h22092 = { 24'd0, dlyReadCredit_value } ;
  assign rdat__h22100 = { 12'd0, dlyWAG } ;
  assign rdat__h22108 = { 12'd0, dlyRAG } ;
  assign v__h22774 = metaRF$D_IN ;
  ...
  assign wrtSerPos_11_PLUS_1___d1010 = wrtSerPos + 2'd1 ;
  assign x1__h20011 = { 96'd0, x__h19947[31:0] } ;
  assign x1__h20020 = { 64'd0, x__h19947[31:0], wrtSerStage } ;
  assign x1__h20540 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h20549 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  ...
  assign x__h15276 =
	     mesgWF_pwEnqueue$whas ? wsiS_reqFifo$D_OUT[79:16] : 64'd0 ;
  assign x__h16094 = mesgRF_rRdPtr + 11'd1 ;
  assign x__h16202 = CAN_FIRE_RL_rdSer_body ? mesgRF_wDataIn$wget : 64'd0 ;
  assign x__h17341 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h19947 = mesgWF_wDataOut$wget ;
  assign x__h21106 = { dlyRAG, 4'h0 } ;
  assign x__h21265 = { dlyWAG, 4'h0 } ;
  assign x__h21904 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h22491 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[14:3] ;
  assign x_byteEn__h22492 = (readMeta[23:0] == 24'd0) ? 8'd0 : 8'd255 ;
  always@(wci_reqF$D_OUT or
	  ...
	  wmemiRdReq or
	  wmemiRdResp or
	  rdat__h22084 or rdat__h22092 or rdat__h22100 or rdat__h22108)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h21858 = dlyCtrl;
      20'h00004: x_data__h21858 = dlyHoldoffBytes;
      20'h00008: x_data__h21858 = dlyHoldoffCycles;
      20'h0000C: x_data__h21858 = mesgWtCount;
      20'h00010: x_data__h21858 = mesgRdCount;
      20'h00014: x_data__h21858 = bytesWritten;
      20'h00018: x_data__h21858 = rdat__h21901;
      20'h0001C: x_data__h21858 = 32'd0;
      20'h00020: x_data__h21858 = wsiS_extStatusW$wget[95:64];
      20'h00024: x_data__h21858 = wsiS_extStatusW$wget[63:32];
      20'h00028: x_data__h21858 = wsiS_extStatusW$wget[31:0];
      20'h0002C: x_data__h21858 = wsiM_extStatusW$wget[95:64];
      20'h00030: x_data__h21858 = wsiM_extStatusW$wget[63:32];
      20'h00034: x_data__h21858 = wsiM_extStatusW$wget[31:0];
      20'h00038: x_data__h21858 = wmemiWrReq;
      20'h0003C: x_data__h21858 = wmemiRdReq;
      20'h00040: x_data__h21858 = wmemiRdResp;
      20'h00044: x_data__h21858 = rdat__h22084;
      20'h00048: x_data__h21858 = rdat__h22092;
      20'h0004C: x_data__h21858 = rdat__h22100;
      20'h00050: x_data__h21858 = rdat__h22108;
      default: x_data__h21858 = 32'd0;
    endcase
  end
  ...
  begin
	...
	errCount <= `BSV_ASSIGNMENT_DELAY 64'd0;
	...
	mesgRF_rCache <= `BSV_ASSIGNMENT_DELAY 76'h2AAAAAAAAAAAAAAAAAA;
	...
	mesgWF_rCache <= `BSV_ASSIGNMENT_DELAY 76'h2AAAAAAAAAAAAAAAAAA;
	...
	valExpect <= `BSV_ASSIGNMENT_DELAY 64'd0;
  ...
  begin
    ...
    doAbort = 1'h0;
    endOfMessage = 1'h0;
    errCount = 64'hAAAAAAAAAAAAAAAA;
    impreciseBurst = 1'h0;
    mesgLength = 15'h2AAA;
    mesgLengthSoFar = 14'h2AAA;
    mesgRF_rCache = 76'hAAAAAAAAAAAAAAAAAAA;
    mesgRF_rRdPtr = 11'h2AA;
    mesgRF_rWrPtr = 11'h2AA;
    mesgRdCount = 32'hAAAAAAAA;
    mesgReqValid = 1'h0;
    mesgWF_rCache = 76'hAAAAAAAAAAAAAAAAAAA;
    ...
    readyToRequest = 1'h0;
    unrollCnt = 16'hAAAA;
    valExpect = 64'hAAAAAAAAAAAAAAAA;
    wci_cEdge = 3'h2;
    wci_cState = 3'h2;
    wci_ctlAckReg = 1'h0;
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_mesgBegin && wsiS_reqFifo$D_OUT[92])
	begin
	  v__h19158 = $time;
	  #0;
	end
