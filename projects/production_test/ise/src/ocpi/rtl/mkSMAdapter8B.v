...
//
// On Thu Jun 10 21:52:28 PDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  wire [63 : 0] wmiM_MData, wsiM1_MData;
  wire [31 : 0] wciS0_SData, wmiM_MFlag;
  wire [13 : 0] wmiM_MAddr;
  wire [11 : 0] wmiM_MBurstLength, wsiM1_MBurstLength;
  wire [7 : 0] wmiM_MDataByteEn, wsiM1_MByteEn, wsiM1_MReqInfo;
  ...
  wire [73 : 0] wmi_dhF_x_wire$wget;
  wire [65 : 0] wmi_wmiResponse$wget;
  wire [63 : 0] wmi_Em_sData_w$wget, wsi_Es_mData_w$wget;
  ...
  reg [73 : 0] wmi_dhF_q_0$D_IN;
  wire wmi_dhF_q_0$EN;

  // register wmi_dhF_q_1
  reg [73 : 0] wmi_dhF_q_1;
  reg [73 : 0] wmi_dhF_q_1$D_IN;
  wire wmi_dhF_q_1$EN;
  ...
  wire [65 : 0] wmi_respF$D_IN, wmi_respF$D_OUT;
  wire wmi_respF$CLR,
       wmi_respF$DEQ,
       wmi_respF$EMPTY_N,
       wmi_respF$ENQ,
  ...
  reg [63 : 0] v__h15366,
	       ...
	       v__h2811,
	       v__h3711;
  reg [31 : 0] value__h6096, x_data__h15499;
  wire [31 : 0] rdat__h15593;
  wire [23 : 0] mesgMetaF_length__h16865, mesgMetaF_length__h17777;
  wire [15 : 0] wsiBurstLength__h18511, x__h15596, x_length__h17141;
  wire [13 : 0] IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d750,
		addr__h16703,
		b__h19143,
		mlp1B__h16687,
		mlp1__h16686;
  wire [11 : 0] bl__h17634, x_burstLength__h18617;
  wire [7 : 0] mesgMetaF_opcode__h16864, x_byteEn__h18619;
  wire [3 : 0] b__h13989;
  wire NOT_wmi_reqF_c_r_46_EQ_2_47_48_AND_wmi_operate_ETC___d292,
       NOT_wsiS_reqFifo_countReg_56_ULE_1_57___d358,
  ...
  // value method wmiM_mDataValid
  assign wmiM_MDataValid = !wmi_sDataThreadBusy_d && wmi_dhF_q_0[73] ;

  // value method wmiM_mDataLast
  assign wmiM_MDataLast = wmi_dhF_q_0[72] ;

  // value method wmiM_mData
  assign wmiM_MData = wmi_dhF_q_0[71:8] ;

  // value method wmiM_mDataByteEn
  assign wmiM_MDataByteEn = wmi_dhF_q_0[7:0] ;
  ...
  // submodule wmi_respF
  FIFO2 #(.width(32'd66), .guarded(32'd1)) wmi_respF(.RST_N(wciS0_MReset_n),
						     .CLK(wciS0_Clk),
						     .D_IN(wmi_respF$D_IN),
						     .ENQ(wmi_respF$ENQ),
						     .DEQ(wmi_respF$DEQ),
  ...
  assign CAN_FIRE_RL_wmrd_mesgBodyRequest =
	     NOT_wmi_reqF_c_r_46_EQ_2_47_48_AND_wmi_operate_ETC___d292 &&
	     wci_cState == 3'd2 &&
  ...
  assign CAN_FIRE_RL_wmi_respAdvance =
	     ...
	     wmi_wmiResponse$wget[65:64] != 2'd0 ;
  ...
  assign MUX_unrollCnt$write_1__VAL_1 =
	     (wmi_sFlagReg[23:0] == 24'd0) ? 16'd1 : wmi_sFlagReg[18:3] ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h15499 } ;
  ...
  assign MUX_wci_respF_q_1$write_1__VAL_1 =
	     (wci_respF_c_r == 2'd2) ?
	       MUX_wci_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_mesgLength$write_1__VAL_4 = { 1'd1, mlp1B__h16687 } ;
  assign MUX_endOfMessage$write_1__SEL_1 =
	     WILL_FIRE_RL_wmwt_messagePushImprecise && x__h16771 ;
  ...
  assign MUX_fabWordsRemain$write_1__VAL_1 =
	     (wmi_sFlagReg[23:0] == 24'd0) ? 14'd1 : wmi_sFlagReg[16:3] ;
  ...
  assign MUX_mesgReqAddr$write_1__VAL_2 =
	     mesgReqAddr + { fabWordsCurReq[10:0], 3'd0 } ;
  ...
  assign MUX_wmi_dhF_x_wire$wset_1__VAL_2 =
	     { 1'd1, x__h16771, wsiS_reqFifo$D_OUT[79:16], 8'd255 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_1 =
	     { mesgMetaF_opcode__h16864, mesgMetaF_length__h16865 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, x__h16771, 1'b0, addr__h16703, 12'd1 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd5, x__h18943, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_1 =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       !smaCtrl[5],
	       x_burstLength__h18617,
	       wmi_respF$D_OUT[63:0],
	       x_byteEn__h18619,
	       thisMesg[23:16] } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_2 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h18943 ;
  assign MUX_fabRespCredit_value$write_1__VAL_2 =
	     fabRespCredit_value +
	     (CAN_FIRE_RL_wmrd_mesgBodyRequest ? b__h13989 : 4'd0) +
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h16864, x_length__h17141 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_1 = { 20'd229376, bl__h17634 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { mesgMetaF_opcode__h16864, mesgMetaF_length__h17777 } ;
  assign MUX_wmi_mFlagF_q_0$write_1__VAL_1 =
	     (wmi_mFlagF_c_r == 2'd1) ? value__h6096 : wmi_mFlagF_q_1 ;
  assign MUX_wmi_mFlagF_q_1$write_1__VAL_1 =
	     (wmi_mFlagF_c_r == 2'd2) ? value__h6096 : 32'd0 ;
  ...
  assign fabRespCredit_acc_v1$wget = b__h13989 ;
  ...
  assign wmi_mFlagF_x_wire$wget = value__h6096 ;
  ...
  assign errCount$EN =
	     ...
	     (!x__h16771 || wsiS_reqFifo$D_OUT[15:8] != 8'd0) ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h19143) ? fabWordsRemain : b__h19143 ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_dhF_decCtr: wmi_dhF_q_1$D_IN = 74'h0AAAAAAAAAAAAAAAAAA;
  ...
  always@(WILL_FIRE_RL_wmi_mFlagF_both or
	  ...
	  value__h6096 or WILL_FIRE_RL_wmi_mFlagF_decCtr or wmi_mFlagF_q_1)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_wmi_mFlagF_both:
	  wmi_mFlagF_q_0$D_IN = MUX_wmi_mFlagF_q_0$write_1__VAL_1;
      MUX_wmi_mFlagF_q_0$write_1__SEL_2: wmi_mFlagF_q_0$D_IN = value__h6096;
  ...
  always@(WILL_FIRE_RL_wmi_mFlagF_both or
	  ...
	  value__h6096 or WILL_FIRE_RL_wmi_mFlagF_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_wmi_mFlagF_both:
	  wmi_mFlagF_q_1$D_IN = MUX_wmi_mFlagF_q_1$write_1__VAL_1;
      MUX_wmi_mFlagF_q_1$write_1__SEL_2: wmi_mFlagF_q_1$D_IN = value__h6096;
  ...
  // remaining internal signals
  assign IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d750 =
	     mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign NOT_wmi_reqF_c_r_46_EQ_2_47_48_AND_wmi_operate_ETC___d292 =
	     wmi_reqF_c_r != 2'd2 && wmi_operateD && wmi_peerIsReady &&
	     (!x__h18943 || wmi_mFlagF_c_r != 2'd2) ;
  assign NOT_wsiS_reqFifo_countReg_56_ULE_1_57___d358 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign addr__h16703 = { mesgLengthSoFar[10:0], 3'd0 } ;
  assign b__h13989 = -fabWordsCurReq[3:0] ;
  assign b__h19143 = { {10{fabRespCredit_value[3]}}, fabRespCredit_value } ;
  assign bl__h17634 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 1'd0,
		 IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d750[13:3] } ;
  assign mesgMetaF_length__h16865 = { 10'd0, mlp1B__h16687 } ;
  assign mesgMetaF_length__h17777 =
	     { 10'd0,
	       IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d750 } ;
  assign mesgMetaF_opcode__h16864 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlp1B__h16687 = { mlp1__h16686[10:0], 3'd0 } ;
  assign mlp1__h16686 = MUX_mesgLengthSoFar$write_1__VAL_2 ;
  assign rdat__h15593 = { 16'd0, x__h15596 } ;
  assign wsiBurstLength__h18511 =
	     smaCtrl[5] ? 16'd2 : { 3'd0, thisMesg[15:3] } ;
  assign wsiS_reqFifo_i_notEmpty__52_AND_wmi_operateD_5_ETC___d165 =
	     wsiS_reqFifo$EMPTY_N && wmi_operateD && wmi_peerIsReady &&
	     (!x__h16771 || wmi_mFlagF_c_r != 2'd2) ;
  assign x__h15596 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h16771 = wsiS_reqFifo$D_OUT[91:80] == 12'd1 ;
  assign x__h18943 = fabWordsRemain == fabWordsCurReq ;
  assign x_burstLength__h18617 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h18511[11:0]) ;
  assign x_byteEn__h18619 = (thisMesg[15:0] == 16'd0) ? 8'd0 : 8'd255 ;
  assign x_length__h17141 =
	     { 2'd0,
	       IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d750 } ;
  always@(wci_reqF$D_OUT or
	  ...
	  thisMesg or
	  lastMesg or
	  rdat__h15593 or wsiS_extStatusW$wget or wsiM_extStatusW$wget)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: x_data__h15499 = smaCtrl;
      8'h04: x_data__h15499 = mesgCount;
      8'h08: x_data__h15499 = abortCount;
      8'h10: x_data__h15499 = thisMesg;
      8'h14: x_data__h15499 = lastMesg;
      8'h18: x_data__h15499 = rdat__h15593;
      8'h20: x_data__h15499 = wsiS_extStatusW$wget[95:64];
      8'h24: x_data__h15499 = wsiS_extStatusW$wget[63:32];
      8'h28: x_data__h15499 = wsiS_extStatusW$wget[31:0];
      8'h2C: x_data__h15499 = wsiM_extStatusW$wget[95:64];
      8'h30: x_data__h15499 = wsiM_extStatusW$wget[63:32];
      8'h34: x_data__h15499 = wsiM_extStatusW$wget[31:0];
      default: x_data__h15499 = 32'd0;
    endcase
  end
  always@(MUX_endOfMessage$write_1__SEL_1 or
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_endOfMessage$write_1__SEL_1:
	  value__h6096 = MUX_wmi_mFlagF_x_wire$wset_1__VAL_1;
      MUX_wmi_mFlagF_x_wire$wset_1__SEL_2:
	  value__h6096 = 32'hAAAAAAAA /* unspecified value */ ;
      WILL_FIRE_RL_wmwt_requestPrecise:
	  value__h6096 = MUX_wmi_mFlagF_x_wire$wset_1__VAL_3;
      default: value__h6096 = 32'hAAAAAAAA /* unspecified value */ ;
    endcase
  end
  ...
  begin
	...
	wmi_dhF_q_0 <= `BSV_ASSIGNMENT_DELAY 74'h0AAAAAAAAAAAAAAAAAA;
	wmi_dhF_q_1 <= `BSV_ASSIGNMENT_DELAY 74'h0AAAAAAAAAAAAAAAAAA;
  ...
  begin
    ...
    wmi_dhF_c_r = 2'h2;
    wmi_dhF_q_0 = 74'h2AAAAAAAAAAAAAAAAAA;
    wmi_dhF_q_1 = 74'h2AAAAAAAAAAAAAAAAAA;
    wmi_mFlagF_c_r = 2'h2;
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h16539);
    if (wciS0_MReset_n)
