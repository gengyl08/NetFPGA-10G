...
//
// On Thu Jun 10 21:52:31 PDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
// wmiM_MData                     O   128 reg
// wmiM_MDataByteEn               O    16 reg
// wmiM_MFlag                     O    32
// wmiM_MReset_n                  O     1
// wsiM1_MCmd                     O     3
// wsiM1_MReqLast                 O     1
...
module mkSMAdapter16B(wciS0_Clk,
		      wciS0_MReset_n,
  ...
  wire [127 : 0] wmiM_MData, wsiM1_MData;
  wire [31 : 0] wciS0_SData, wmiM_MFlag;
  wire [15 : 0] wmiM_MDataByteEn, wsiM1_MByteEn;
  ...
  wire [145 : 0] wmi_dhF_x_wire$wget;
  wire [129 : 0] wmi_wmiResponse$wget;
  wire [127 : 0] wmi_Em_sData_w$wget, wsi_Es_mData_w$wget;
  ...
  reg [145 : 0] wmi_dhF_q_0$D_IN;
  wire wmi_dhF_q_0$EN;

  // register wmi_dhF_q_1
  reg [145 : 0] wmi_dhF_q_1;
  reg [145 : 0] wmi_dhF_q_1$D_IN;
  wire wmi_dhF_q_1$EN;
  ...
  wire [129 : 0] wmi_respF$D_IN, wmi_respF$D_OUT;
  wire wmi_respF$CLR,
       wmi_respF$DEQ,
       wmi_respF$EMPTY_N,
       wmi_respF$ENQ,
  ...
  wire [15 : 0] wsiBurstLength__h18511,
		x__h15596,
		x_byteEn__h18619,
		x_length__h17141;
  ...
  wire [7 : 0] mesgMetaF_opcode__h16864;
  wire [3 : 0] b__h13989;
  ...
  // value method wmiM_mDataValid
  assign wmiM_MDataValid = !wmi_sDataThreadBusy_d && wmi_dhF_q_0[145] ;

  // value method wmiM_mDataLast
  assign wmiM_MDataLast = wmi_dhF_q_0[144] ;

  // value method wmiM_mData
  assign wmiM_MData = wmi_dhF_q_0[143:16] ;

  // value method wmiM_mDataByteEn
  assign wmiM_MDataByteEn = wmi_dhF_q_0[15:0] ;
  ...
  // submodule wmi_respF
  FIFO2 #(.width(32'd130), .guarded(32'd1)) wmi_respF(.RST_N(wciS0_MReset_n),
						      .CLK(wciS0_Clk),
						      .D_IN(wmi_respF$D_IN),
						      .ENQ(wmi_respF$ENQ),
						      .DEQ(wmi_respF$DEQ),
  ...
  assign MUX_unrollCnt$write_1__VAL_1 =
	     (wmi_sFlagReg[23:0] == 24'd0) ? 16'd1 : wmi_sFlagReg[19:4] ;
  ...
  assign MUX_fabWordsRemain$write_1__VAL_1 =
	     (wmi_sFlagReg[23:0] == 24'd0) ? 14'd1 : wmi_sFlagReg[17:4] ;
  ...
  assign MUX_wmi_dhF_x_wire$wset_1__VAL_2 =
	     { 1'd1, x__h16771, wsiS_reqFifo$D_OUT[151:24], 16'd65535 } ;
  ...
  assign errCount$EN =
	     ...
	     (!x__h16771 || wsiS_reqFifo$D_OUT[23:8] != 16'd0) ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_dhF_decCtr:
	  wmi_dhF_q_1$D_IN = 146'h0AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;
  ...
  assign NOT_wsiS_reqFifo_countReg_56_ULE_1_57___d358 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign addr__h16703 = { mesgLengthSoFar[9:0], 4'd0 } ;
  ...
  assign bl__h17634 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 2'd0,
		 IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d750[13:4] } ;
  ...
  assign mlp1B__h16687 = { mlp1__h16686[9:0], 4'd0 } ;
  ...
  assign x__h16771 = wsiS_reqFifo$D_OUT[163:152] == 12'd1 ;
  ...
  assign x_byteEn__h18619 =
	     (thisMesg[15:0] == 16'd0) ? thisMesg[15:0] : 16'd65535 ;
