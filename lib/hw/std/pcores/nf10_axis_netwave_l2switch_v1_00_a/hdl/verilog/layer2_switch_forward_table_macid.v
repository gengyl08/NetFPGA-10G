...
module layer2_switch_forward_table_macid_core (q, ra, ce, clk
, d, wa, we);
   parameter READ_PORT_COUNT=32'd1;
   parameter WRITE_PORT_COUNT=32'd1;
   parameter DATA_WIDTH=32'd48;
   parameter ADDRESS_WIDTH=32'd2;
   parameter WORD_COUNT=32'd3;
   ...
   initial begin
        mem[0] = 48'b000000000000000000000000000000000000000000000000;
        mem[1] = 48'b000000000000000000000000000000000000000000000000;
        mem[2] = 48'b000000000000000000000000000000000000000000000000;
   end
...
module layer2_switch_forward_table_macid (
    address0,
    ce0,
    q0,
    we0,
...
layer2_switch_forward_table_macid_core #(
    .READ_PORT_COUNT( 1 ),
    .WRITE_PORT_COUNT( 1 ),
