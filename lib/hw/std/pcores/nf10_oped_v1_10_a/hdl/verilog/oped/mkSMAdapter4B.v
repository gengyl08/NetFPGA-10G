...
//
// On Sun May 15 09:57:53 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter4B(wciS0_Clk,
  ...
  wire CAN_FIRE_RL_fabRespCredit_accumulate,
       ...
       CAN_FIRE_RL_respF_portA,
       CAN_FIRE_RL_respF_portB,
       CAN_FIRE_RL_respF_portB_read_data,
       ...
       CAN_FIRE_RL_wmi_isReset_isResetAssertedUpdate,
       ...
       CAN_FIRE_RL_wmrd_mesgResptoWsi,
       ...
       WILL_FIRE_RL_respF_portA,
       WILL_FIRE_RL_respF_portB,
       WILL_FIRE_RL_respF_portB_read_data,
       ...
       WILL_FIRE_RL_wmi_isReset_isResetAssertedUpdate,
  ...
  reg [31 : 0] MUX_wmi_reqF_q_0$write_1__VAL_1;
  ...
  wire [31 : 0] MUX_mesgCount$write_1__VAL_1,
		...
		MUX_wmi_reqF_q_1$write_1__VAL_2,
  ...
  wire MUX_endOfMessage$write_1__SEL_1,
       ...
       MUX_wmi_reqF_q_0$write_1__SEL_1,
       MUX_wmi_reqF_q_1$write_1__SEL_1,
       ...
       MUX_wsiS_reqFifo_levelsValid$write_1__SEL_5;
  ...
  wire [55 : 0] IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d842;
  ...
  wire [2 : 0] IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d843;
  ...
  // rule RL_wmi_isReset_isResetAssertedUpdate
  assign CAN_FIRE_RL_wmi_isReset_isResetAssertedUpdate =
	     wmi_isReset_isInReset ;
  assign WILL_FIRE_RL_wmi_isReset_isResetAssertedUpdate =
	     wmi_isReset_isInReset ;
  ...
  // rule RL_respF_portB_read_data
  assign CAN_FIRE_RL_respF_portB_read_data = 1'd1 ;
  assign WILL_FIRE_RL_respF_portB_read_data = 1'd1 ;

  // rule RL_wmrd_mesgResptoWsi
  assign CAN_FIRE_RL_wmrd_mesgResptoWsi =
	     wsiM_reqFifo_c_r != 2'd2 && respF_rRdPtr != respF_rWrPtr &&
	     wci_wslv_cState == 3'd2 &&
	     (smaCtrl[3:0] == 4'h1 || smaCtrl[3:0] == 4'h4 ||
	      smaCtrl[3:0] == 4'h9) ;
  assign WILL_FIRE_RL_wmrd_mesgResptoWsi = CAN_FIRE_RL_wmrd_mesgResptoWsi ;
  ...
  // rule RL_respF_portA
  assign CAN_FIRE_RL_respF_portA = 1'd1 ;
  assign WILL_FIRE_RL_respF_portA = 1'd1 ;

  // rule RL_respF_portB
  assign CAN_FIRE_RL_respF_portB = 1'd1 ;
  assign WILL_FIRE_RL_respF_portB = 1'd1 ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__SEL_2 =
	     WILL_FIRE_RL_wci_wslv_respF_incCtr &&
	     wci_wslv_respF_c_r == 2'd1 ;
  assign MUX_wmi_dhF_q_0$write_1__SEL_1 =
  ...
  assign MUX_wmi_reqF_q_0$write_1__SEL_1 =
	     WILL_FIRE_RL_wmi_reqF_incCtr && wmi_reqF_c_r == 2'd0 ;
  assign MUX_wmi_reqF_q_1$write_1__SEL_1 =
  ...
  assign MUX_wsiS_reqFifo_levelsValid$write_1__SEL_5 =
	     WILL_FIRE_RL_wsiS_reqFifo_enq && wsiS_reqFifo$FULL_N ;
  assign MUX_fabRespCredit_value$write_1__VAL_2 =
	     fabRespCredit_value +
	     (CAN_FIRE_RL_wmrd_mesgBodyRequest ? b__h15200 : 12'd0) +
	     (CAN_FIRE_RL_wmrd_mesgResptoWsi ? 12'd1 : 12'd0) ;
  ...
  assign MUX_wmi_dhF_q_0$write_1__VAL_2 =
	     (wmi_dhF_c_r == 2'd1) ?
	       MUX_wmi_dhF_q_0$write_1__VAL_1 :
	       wmi_dhF_q_1 ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_wmrd_mesgBodyRequest:
	  MUX_wmi_reqF_q_0$write_1__VAL_1 = MUX_wmi_reqF_x_wire$wset_1__VAL_1;
      WILL_FIRE_RL_wmwt_requestPrecise:
	  MUX_wmi_reqF_q_0$write_1__VAL_1 = MUX_wmi_reqF_x_wire$wset_1__VAL_2;
      WILL_FIRE_RL_wmwt_messagePushImprecise:
	  MUX_wmi_reqF_q_0$write_1__VAL_1 = MUX_wmi_reqF_x_wire$wset_1__VAL_3;
      default: MUX_wmi_reqF_q_0$write_1__VAL_1 =
  ...
  assign MUX_wmi_reqF_q_0$write_1__VAL_2 =
	     (wmi_reqF_c_r == 2'd1) ?
	       ...
	       wmi_reqF_q_1 ;
  assign MUX_wmi_reqF_q_1$write_1__VAL_2 =
	     (wmi_reqF_c_r == 2'd2) ?
	       MUX_wmi_reqF_q_0$write_1__VAL_1 :
	       32'd178956970 ;
  ...
  assign wmi_reqF_x_wire$wget = MUX_wmi_reqF_q_0$write_1__VAL_1 ;
  ...
  assign wmi_dhF_x_wire$wget = MUX_wmi_dhF_q_0$write_1__VAL_1 ;
  ...
  assign fabRespCredit_acc_v2$whas = CAN_FIRE_RL_wmrd_mesgResptoWsi ;
  ...
  assign respF_pwDequeue$whas = CAN_FIRE_RL_wmrd_mesgResptoWsi ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_3 ? 14'd0 : mlp1__h21052 ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d843,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[57],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[56],
	       IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d842 } ;
  assign respF_rCache$EN = respF_pwEnqueue$whas ;

  // register respF_rRdPtr
  assign respF_rRdPtr$D_IN = x__h16554 ;
  assign respF_rRdPtr$EN = CAN_FIRE_RL_wmrd_mesgResptoWsi ;
  ...
  // register wmi_dhF_q_0
  always@(MUX_wmi_dhF_q_0$write_1__SEL_1 or
	  MUX_wmi_dhF_q_0$write_1__VAL_1 or
	  WILL_FIRE_RL_wmi_dhF_both or
  ...
  // register wmi_dhF_q_1
  always@(MUX_wmi_dhF_q_1$write_1__SEL_1 or
	  MUX_wmi_dhF_q_0$write_1__VAL_1 or
	  WILL_FIRE_RL_wmi_dhF_both or
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_wmi_dhF_q_1$write_1__SEL_1:
	  wmi_dhF_q_1$D_IN = MUX_wmi_dhF_q_0$write_1__VAL_1;
      WILL_FIRE_RL_wmi_dhF_both:
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_wmi_mFlagF_q_0$write_1__SEL_1: wmi_mFlagF_q_0$D_IN = value__h6626;
      WILL_FIRE_RL_wmi_mFlagF_both:
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_wmi_mFlagF_q_1$write_1__SEL_1: wmi_mFlagF_q_1$D_IN = value__h6626;
      WILL_FIRE_RL_wmi_mFlagF_both:
  ...
  // register wmi_reqF_q_0
  always@(MUX_wmi_reqF_q_0$write_1__SEL_1 or
  ...
  // register wmi_reqF_q_1
  always@(MUX_wmi_reqF_q_1$write_1__SEL_1 or
	  MUX_wmi_reqF_q_0$write_1__VAL_1 or
	  WILL_FIRE_RL_wmi_reqF_both or
	  MUX_wmi_reqF_q_1$write_1__VAL_2 or WILL_FIRE_RL_wmi_reqF_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_wmi_reqF_q_1$write_1__SEL_1:
	  wmi_reqF_q_1$D_IN = MUX_wmi_reqF_q_0$write_1__VAL_1;
      WILL_FIRE_RL_wmi_reqF_both:
	  wmi_reqF_q_1$D_IN = MUX_wmi_reqF_q_1$write_1__VAL_2;
  ...
  assign wmwtFinalCount$EN = CAN_FIRE_RL_wmwt_messageFinalize ;

  // register wmwtPImpCount
  assign wmwtPImpCount$D_IN = wmwtPImpCount + 32'd1 ;
  assign wmwtPImpCount$EN = WILL_FIRE_RL_wmwt_messagePushImprecise ;
  ...
  assign wsiS_trafficSticky$EN = MUX_wsiS_reqFifo_levelsValid$write_1__SEL_5 ;

  // register wsiS_wordCount
  assign wsiS_wordCount$D_IN =
	     wsiS_wsiReq$wget[57] ? 12'd1 : wsiS_wordCount + 12'd1 ;
  assign wsiS_wordCount$EN = MUX_wsiS_reqFifo_levelsValid$write_1__SEL_5 ;
  ...
  assign mesgTokenF$DEQ = CAN_FIRE_RL_wmwt_messageFinalize ;
  ...
  assign wsiS_reqFifo$ENQ = MUX_wsiS_reqFifo_levelsValid$write_1__SEL_5 ;
  assign wsiS_reqFifo$DEQ = wsiS_reqFifo_r_deq$whas ;
  assign wsiS_reqFifo$CLR = 1'b0 ;

  // remaining internal signals
  assign IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d842 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[55:0] : 56'd0 ;
  assign IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d843 =
  ...
  assign mlp1__h21052 = mesgLengthSoFar + 14'd1 ;
