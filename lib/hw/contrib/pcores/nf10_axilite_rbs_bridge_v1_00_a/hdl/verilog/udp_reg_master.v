 ...
 *
 *  Description:
 *        AXI - Register Bus (NetFPGA 1G reference pipeline) conversion library.
 *
 *  Note:
 *        Set TIMEOUT_RESULT to specify the return value on timeout.
 *        This can be used to identify broken rings.
 *
 *  Result: ack_in -> data_in
 *          timeout -> TIMEOUT_RESULT
 *          loop complete && !ack_in -> deadbee
 *
 *  Copyright notice:
...
module udp_reg_master
   #(
      ...
      parameter TIMEOUT_RESULT = 'h dead_beef,
      parameter UDP_REG_SRC_WIDTH = 2,
      parameter UDP_REG_ADDR_WIDTH = 23,
