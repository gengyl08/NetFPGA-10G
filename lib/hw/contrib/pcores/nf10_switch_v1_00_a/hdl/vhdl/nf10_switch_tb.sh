...
#        nf10_switch_v1_00_a module, and to
...
cd     unittest_build
fuse -incremental -prj ../nf10_switch_tb.prj -o nf10_switch_tb.exe work.testbench
./nf10_switch_tb.exe -tclbatch ../nf10_switch_tb.tcl
