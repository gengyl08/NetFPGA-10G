...
void run(int dev)
{
	...
	printf("Read RO_REG2 (%x) == W0_REG0 (%x)\r\n", reg_rd(dev, BAR0_BASE_ADDRESS + RO_REG2), reg_rd(dev, BAR0_BASE_ADDRESS + WO_REG0));
	printf("Read RO_REG3 (%x) == W0_REG1 (%x)\r\n", reg_rd(dev, BAR0_BASE_ADDRESS + RO_REG3), reg_rd(dev, BAR0_BASE_ADDRESS + WO_REG1));
	...
	// Write Row 1
        printf("--- Row 1 ---");
	reg_wr(dev, BAR1_BASE_ADDRESS + TBL_COL1, 0xfeed1111);
	printf("Write TBL_COL0 (%x)\r\n", 0xfeed1111);
	...
	// Write Row 2
        printf("--- Row 2 ---");
	reg_wr(dev, BAR1_BASE_ADDRESS + TBL_COL1, 0xfeed2221);
	printf("Write TBL_COL0 (%x)\r\n", 0xfeed2221);
	...
	// Write Row 3
        printf("--- Row 3 ---");
	reg_wr(dev, BAR1_BASE_ADDRESS + TBL_COL1, 0xfeed3331);
	printf("Write TBL_COL0 (%x)\r\n", 0xfeed3331);
