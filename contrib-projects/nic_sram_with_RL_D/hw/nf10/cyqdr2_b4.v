...
//
//  
//	Model:	CY7C1515JV18 2M X 36 QDR(tm)-II Burst-of-4 SRAM
// 	Date:		March 9, 2007
//
//	Revision:	1.0
//
...
reg[106:0] bsr;		// 109-bit boundary scan register.
...
begin 
	state = `reset;
	prev_state = `reset;
	vendor_code = 32'b00111010011011100100000001101001;	// IDCODE for QDR2 CY7C1315BV18 device. This may not be changed.
	tdo_tristate = 1;
	extest_en = 0;
	samplz_en = 0;
	extest_oe = 0;
