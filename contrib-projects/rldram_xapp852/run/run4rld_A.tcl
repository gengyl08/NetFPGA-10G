# 
# Project automation script for run 
# 
# Created for ISE version 13.4
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source run.tcl), then you can
...
proc run_process {} {
   ...
   # Copy NF10 define file: nf10_defs.v (Added by Shahbaz)
   file copy -force ../nf10_defs.v ./
...
proc add_source_files {} {
   ...
   xfile add "../Chipscope/icon.ngc"
   xfile add "../Chipscope/ila256.ngc"
   xfile add "../nf10_rld_if.v"
   xfile add "../nf10_rldram2_A.ucf"
   xfile add "../verilog/backend_rom.v"
   xfile add "../verilog/bcd6.v"
   xfile add "../verilog/cmp_rd_data.v"
   xfile add "../verilog/rld_clk_module.v"
   xfile add "../verilog/rld_conf.v"
   xfile add "../verilog/rld_controller.v"
   xfile add "../verilog/rld_controller_iobs.v"
   xfile add "../verilog/rld_ctl.v"
   xfile add "../verilog/rld_data_path.v"
   xfile add "../verilog/rld_data_path_iobs.v"
   xfile add "../verilog/rld_data_write.v"
   xfile add "../verilog/rld_dly_cal_sm.v"
   xfile add "../verilog/rld_infrastructure_iobs.v"
   xfile add "../verilog/rld_infrastructure_top.v"
   xfile add "../verilog/rld_iobs.v"
   xfile add "../verilog/rld_main.v"
   xfile add "../verilog/rld_mem_interface_top.v"
   xfile add "../verilog/rld_phy_calib.v"
   xfile add "../verilog/rld_rst.v"
   xfile add "../verilog/rld_seven_seg.v"
   xfile add "../verilog/rld_tap_logic.v"
   xfile add "../verilog/rld_top.v"
   xfile add "../verilog/rld_user_interface.v"
   xfile add "../verilog/rld_v4_dm_iob.v"
   xfile add "../verilog/rld_v4_dq_iob.v"
   xfile add "../verilog/rld_v4_qk_iob.v"
   xfile add "../verilog/rld_v4_qvld_iob.v"
   xfile add "../verilog/rld_v5_dm_iob.v"
   xfile add "../verilog/rld_v5_dq_iob.v"
   xfile add "../verilog/rld_v5_qk_iob.v"
   xfile add "../verilog/test_bench.v"

   # Set the Top Module as well...
   project set top "nf10_rld_if"
